        ...
        return (
            <div className="flex flex-col items-center justify-center h-full gap-5 ">
                ...
                <form className="flex flex-col items-center gap-5" onSubmit={this.handleSubmit}>
                    ...
                    <button type="submit"  className="bg-sky-500 hover:bg-sky-700 px-5 py-2.5 text-sm leading-5 rounded-md font-semibold text-white" >S'inscrire</button>
                </form>
                <Link to= "/login" className="text-sky-500 hover:text-sky-700">Déjà inscrit ? Connectez-vous !</Link>
